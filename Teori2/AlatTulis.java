...
public class AlatTulis {
    ...
    public static int totalHargaSemuaBarang(AlatTulis bolpoint, AlatTulis pensil, AlatTulis penghapus) {
        int totalSemua = 0;
        totalSemua += bolpoint.getHargaTotal();
        totalSemua += pensil.getHargaTotal();
        totalSemua += penghapus.getHargaTotal();
        return totalSemua;
    }    
}
